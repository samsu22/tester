...
#install ssh ovpn
wget https://raw.githubusercontent.com/samsu22/tester/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
wget https://raw.githubusercontent.com/samsu22/tester/main/sodosok.sh && chmod +x sodosok.sh && ./sodosok.sh
#installwg
...
wget https://raw.githubusercontent.com/samsu22/tester/main/inswssh.sh && chmod +x inswssh.sh && ./inswssh.sh
# set time GMT +8
